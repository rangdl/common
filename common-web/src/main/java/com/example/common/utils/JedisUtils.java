...
public class JedisUtils {
     ...
     */
    public void saveObject(String key, Object obj, int seconds) {
        if(seconds>0){
     ...
     * @param val
     */
    public void hashSet(String hName, String key, String val) {
        valOpsHash.put(hName, key, val);
    }
     ...
     * @throws JsonProcessingException
     */
    public <T> void hashSet(String hName, String key, T val) throws JsonProcessingException {
        hashSet(hName, key, mapper.writeValueAsString(val));
    }
     ...
     * @param val
     */
    public void hsetnx(String hName, String key, String val) {
        valOpsHash.putIfAbsent(hName, key, val);
    }
     ...
     * @throws JsonProcessingException
     */
    public <T> void hsetnx(String hName, String key, T val) throws JsonProcessingException {
        hsetnx(hName, key, mapper.writeValueAsString(val));
    }
...
//        redisTemplate.execute((RedisCallback<Long>) connection -> connection.del(key.getBytes()));
     ...
     * @return 列表
     */
    public Set<ZSetOperations.TypedTuple<String>> listSortedsetRev(String key, int start, int end) {
